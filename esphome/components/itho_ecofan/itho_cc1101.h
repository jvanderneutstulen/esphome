...
class IthoCC1101 {
 ...
 public:
  IthoCC1101(CC1101 *cc1101, std::vector<uint8_t> rf_address) : cc1101_(cc1101), rf_address_(std::move(std::move(rf_address))) {};
  ...
  bool has_valid_checksum(std::vector<uint8_t> data) { return this->calc_checksum(std::move(data)) == 0x00; }
